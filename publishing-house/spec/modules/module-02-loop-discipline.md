...
- Round 1's maturity commitment: vLLM serving is GA, but the tool-calling configuration guide is Developer Preview and not Red Hat supported. See the maturity table in `design.md`.
